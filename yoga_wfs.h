...
class yoga_wfs {
 ...
 public:
  yoga_wfs(long nxsub, long nvalid, long npix, long nphase, long nrebin, long nfft, long ntot, long npup);
...
class yoga_sensors {
 ...
 public:
  yoga_sensors(int nwfs,long *nxsub,long *nvalid,long *npix,long *nphase, long *nrebin,long *nfft, long *ntot, long npup);
  ~yoga_sensors();
